package me.benefact.utilities
{
	...
	public class DomainName {
		...
		public function DomainName(name:String) {
			// Normalize:
		 ...
		 * @since 6
		 */
		public function get topPrivateDomain():DomainName {
		 ...
		 *
		 */
		private function ancestor(levels:int):DomainName {
			//      return new InternetDomainName(DOT_JOINER.join(parts.subList(levels, parts.size())));
			return new DomainName(parts.slice(levels).join('.'));
		}
