package me.benefact.expression
{
	public class ExpressionContext
	{
		...
		public function ExpressionContext(route:XML, url:String, value:String, result:Vector.<String>, state:Object = null){
			_route = route;
			_url = url;
			_value = value;
			_result = result;
		...
		public function copy(value:String = null, result:Vector.<String> = null) : ExpressionContext {
			...
			return new ExpressionContext(_route, _url, newValue, newResult, _state);
		}
	}
}