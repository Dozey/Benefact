package Expression
{
	public class ExpressionEvaluator
	{
		...
		public function ExpressionEvaluator(resolver:IExpressionResolver)
		{
			_resolver = resolver;
		}
		...
		public function evaluate(expression:XML, ctx:EvaluationContext) : Boolean {
			use namespace _ns;
		...
		public function evaluateAny(expression:XML, ctx:EvaluationContext) : Boolean {
			use namespace _ns;
		...
		public function evaluateAll(expression:XML, ctx:EvaluationContext) : Boolean {
			use namespace _ns;
		...
		public function evaluateReference(expression:XML, ctx:EvaluationContext) : Boolean {
			use namespace _ns;
		...
		public function evaluateRegex(expression:XML, ctx:EvaluationContext) : Boolean {
			use namespace _ns;
		...
		public function evaluateCompare(expression:XML, ctx:EvaluationContext) : Boolean {
			use namespace _ns;
		...
		public function evaluateContains(expression:XML, ctx:EvaluationContext) : Boolean {
			use namespace _ns;
		...
		public function evaluateStartsWith(expression:XML, ctx:EvaluationContext) : Boolean {
			use namespace _ns;
		...
		public function evaluateEndsWith(expression:XML, ctx:EvaluationContext) : Boolean {
			use namespace _ns;
		...
		public function evaluateFirstIndexOf(expression:XML, ctx:EvaluationContext) : Boolean {
			use namespace _ns;
		...
		public function evaluateLastIndexOf(expression:XML, ctx:EvaluationContext) : Boolean {
			use namespace _ns;
